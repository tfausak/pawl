...
-- Khenra Eternal at three seats -- `afflictSpec`. CR 702.121 melee, the eighth,
-- and the first keyword whose payload is a number read off game state -- CR
-- 508.3b's record of who was declared attacked -- with Wings of the Guard at
-- three seats -- `meleeSpec`. CR 509.3b's blocking-side form
