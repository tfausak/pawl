...
--
-- Shimatsu the Bloodcloaked is the whole card pool for this file: {3}{R} Legendary
-- Creature -- Demon Spirit 0/0, "As Shimatsu enters, sacrifice any number of
-- permanents. Shimatsu enters with that many +1/+1 counters on it."
--
