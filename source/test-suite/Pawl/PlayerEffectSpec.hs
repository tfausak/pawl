...
-- the reductions, no floor and no added components --
-- Pawl.Types.CostAdjustments.minimumMana is Heartstone's sentence and
-- Pawl.Types.CostAdjustments.components is Brutal Suppression's, and no
