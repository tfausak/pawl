    ...
    [ Tasty.testGroup
      ...
      Tasty.testGroup
        ...
        [ HU.testCase "Phase round-trips" $
          ...
          -- array-with-repeats encoding is what carries it. Without this, a
          -- Set-shaped encoder would round-trip green and halve the Stalker's
          -- total toxic value on replay.
