...
spec s = Spec.describe s "Pawl.Codec.TriggeredAbility" $ do
  ...
  Spec.it s "MkTriggeredAbility, Sarcomancy's upkeep trigger (an intervening if)" $
    Common.assertJsonCodec
      ...
      "{\"condition\":{\"type\":\"StepBegins\",\"value\":[{\"type\":\"Beginning\",\"value\":{\"type\":\"Upkeep\"}},{\"type\":\"ControllersTurn\"}]},\"intervening\":{\"type\":\"Condition\",\"value\":[{\"type\":\"Count\",\"value\":[{\"type\":\"InZone\",\"value\":[{\"type\":\"Battlefield\"},{\"type\":\"EachPlayer\"}]},{\"type\":\"HasSubtype\",\"value\":{\"type\":\"Zombie\"}},{\"type\":\"Objects\"}]},{\"type\":\"Exactly\"},{\"type\":\"Literal\",\"value\":0}]},\"modal\":{\"modes\":[{\"effects\":[{\"type\":\"DealDamage\",\"value\":[\"you\",{\"type\":\"Literal\",\"value\":1}]}],\"targetSpecs\":[]}],\"selection\":{\"type\":\"ChooseExactly\",\"value\":1}}}"
