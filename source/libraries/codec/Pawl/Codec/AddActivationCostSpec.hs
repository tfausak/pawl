    ...
    Common.assertCodec
      ...
      ( AddActivationCost.MkAddActivationCost
          { AddActivationCost.whichAbilities = Filter.And [Filter.HasSubtype Subtype.Rebel, Filter.Not Filter.IsToken],
            AddActivationCost.components = [CostComponent.Sacrifice 1 (Filter.HasCardType CardType.Land)]
          }
      )
      """ {"whichAbilities":{"type":"And","value":[{"type":"HasSubtype","value":{"type":"Rebel"}},{"type":"Not","value":{"type":"IsToken"}}]},"components":[{"type":"Sacrifice","value":[1,{"type":"HasCardType","value":{"type":"Land"}}]}]} """
