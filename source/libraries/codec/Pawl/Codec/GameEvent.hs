...
toJson e = case e of
  ...
  GameEvent.AttackerBlocked oid -> Common.tagged "AttackerBlocked" . Just $ ObjectId.toJson oid
...
fromJson value = do
  ...
  case (t, mv) of
    ...
    ("AttackerBlocked", Just v) -> GameEvent.AttackerBlocked <$> ObjectId.fromJson v
