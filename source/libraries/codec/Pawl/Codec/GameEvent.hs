...
toJson e = case e of
  GameEvent.Moved zc pc -> Common.tagged "Moved" . Just . Value.array $ [Codec.encode ZoneChange.codec zc, Codec.encode ProjectedCharacteristics.codec pc]
...
fromJson value = do
  ...
  case (t, mv) of
    ("Moved", Just (Value.Array (Array.MkArray [zc, pc]))) -> GameEvent.Moved <$> Codec.decode ZoneChange.codec zc <*> Codec.decode ProjectedCharacteristics.codec pc
