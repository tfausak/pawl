...
spec s = Spec.describe s "Pawl.Codec.Count" $ do
  Spec.it s "MkCount, in a zone" $
    Common.assertJsonCodec
      ...
      "{\"type\":\"Count\",\"value\":[{\"type\":\"InZone\",\"value\":[{\"type\":\"Battlefield\"},{\"type\":\"EachPlayer\"}]},{\"type\":\"And\",\"value\":[{\"type\":\"HasSubtype\",\"value\":{\"type\":\"Swamp\"}},{\"type\":\"ControlledBy\",\"value\":{\"type\":\"You\"}}]},{\"type\":\"Objects\"}]}"
  ...
  Spec.it s "MkCount, scoped to the event history" $
    Common.assertJsonCodec
      ...
      "{\"type\":\"Count\",\"value\":[{\"type\":\"InHistory\",\"value\":{\"type\":\"MovedBetween\",\"value\":[{\"type\":\"Battlefield\"},{\"type\":\"Graveyard\"}]}},{\"type\":\"HasCardType\",\"value\":{\"type\":\"Creature\"}},{\"type\":\"DistinctCardTypes\"}]}"
  Spec.it s "MkCount, scoped to a slot" $
    Common.assertJsonCodec
      ...
      "{\"type\":\"Count\",\"value\":[{\"type\":\"InZone\",\"value\":[{\"type\":\"Hand\"},{\"type\":\"InSlot\",\"value\":\"target\"}]},{\"type\":\"And\",\"value\":[]},{\"type\":\"Objects\"}]}"
