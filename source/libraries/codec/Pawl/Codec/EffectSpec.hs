...
spec s = Spec.describe s "Pawl.Codec.Effect" $ do
  ...
  Spec.it s "Replace (a conditional self-replacement)" $
    Common.assertJsonCodec
      ...
      "{\"type\":\"Replace\",\"value\":[{\"type\":\"UntilEndOfTurn\"},{\"type\":\"Once\"},{\"type\":\"SelfReplacement\"},{\"measured\":{\"type\":\"Count\",\"value\":[{\"type\":\"InZone\",\"value\":[{\"type\":\"Battlefield\"},{\"type\":\"EachPlayer\"}]},{\"type\":\"And\",\"value\":[{\"type\":\"HasCardType\",\"value\":{\"type\":\"Artifact\"}},{\"type\":\"ControlledBy\",\"value\":{\"type\":\"You\"}}]},{\"type\":\"Objects\"}]},\"comparison\":{\"type\":\"AtLeast\"},\"threshold\":{\"type\":\"Literal\",\"value\":3}},{\"type\":\"DamageR\",\"value\":[{\"whichKind\":null,\"whichSource\":{\"type\":\"TheSource\"}},{\"type\":\"SetAmount\",\"value\":4}]}]}"
