...
spec s = Spec.describe s "Pawl.Codec.Effect" $ do
  ...
  Spec.it s "Conjure" $
    Common.assertJsonCodec
      ...
      toJson
      fromJson
      (Effect.Conjure (Conjure.MkConjure Conjure.defaultQuantity (ConjureCards.Written (Text.pack "Ornithopter" NonEmpty.:| [])) Conjure.defaultSelection ConjureDestination.Hand Nothing))
      " {\"type\":\"Conjure\",\"value\":{\"cards\":{\"type\":\"Written\",\"value\":[\"Ornithopter\"]},\"destination\":{\"type\":\"Hand\"}}} "
  ...
  Spec.it s "CopyStackObject round-trips each of CR 707.10's answers" $ do
    Common.assertJsonCodec
      ...
      toJson
      fromJson
      (Effect.CopyStackObject (CopyStackObject.MkCopyStackObject (ObjectRef.InSlot (SlotName.MkSlotName (Text.pack "spell"))) CopyTargets.ChosenByController CopyStackObject.defaultQuantity CopyStackObject.defaultCopier []))
    ...
    Common.assertJsonCodec
      ...
      toJson
      fromJson
      (Effect.CopyStackObject (CopyStackObject.MkCopyStackObject (ObjectRef.InSlot (SlotName.MkSlotName (Text.pack "spell"))) CopyTargets.Copied CopyStackObject.defaultQuantity CopyStackObject.defaultCopier []))
  ...
  Spec.it s "GrantPlayFromExile round-trips both ObjectRef arms" $ do
    Common.assertJsonCodec
      ...
      toJson
      fromJson
      (Effect.GrantPlayFromExile (GrantPlayFromExile.MkGrantPlayFromExile Duration.UntilEndOfTurn (PlayerRef.Relative PlayerRelation.You) (ObjectRef.InSlot (SlotName.MkSlotName (Text.pack "exiled"))) ManaSpending.AsProduced False PermissionVerb.Play))
      " {\"type\":\"GrantPlayFromExile\",\"value\":{\"duration\":{\"type\":\"UntilEndOfTurn\"},\"ref\":{\"type\":\"InSlot\",\"value\":\"exiled\"}}} "
    Common.assertJsonCodec
      s
      toJson
      fromJson
      (Effect.GrantPlayFromExile (GrantPlayFromExile.MkGrantPlayFromExile Duration.Indefinite (PlayerRef.Relative PlayerRelation.You) (ObjectRef.EachMatching (Filter.HasCardType CardType.Creature)) ManaSpending.AsProduced False PermissionVerb.Play))
  ...
  Spec.it s "GrantPlayFromExile round-trips CR 118.14's spending rider" $
    Common.assertJsonCodec
      ...
      toJson
      fromJson
      (Effect.GrantPlayFromExile (GrantPlayFromExile.MkGrantPlayFromExile Duration.UntilEndOfTurn (PlayerRef.Relative PlayerRelation.You) (ObjectRef.InSlot (SlotName.MkSlotName (Text.pack "exiled"))) ManaSpending.AnyType False PermissionVerb.Play))
  ...
  Spec.it s "GrantPlayFromExile round-trips a grantee other than the resolving controller" $
    Common.assertJsonCodec
      ...
      toJson
      fromJson
      (Effect.GrantPlayFromExile (GrantPlayFromExile.MkGrantPlayFromExile Duration.UntilEndOfTurn (PlayerRef.InSlot (SlotName.MkSlotName (Text.pack "thatPlayer"))) (ObjectRef.InSlot (SlotName.MkSlotName (Text.pack "exiled"))) ManaSpending.AsProduced False PermissionVerb.Play))
  ...
  Spec.it s "MakePlotted round-trips both ObjectRef arms, and is not GrantPlayFromExile" $ do
    ...
    Spec.assertBool
      ...
      ( toJson (Effect.MakePlotted (ObjectRef.InSlot (SlotName.MkSlotName (Text.pack "plotted"))))
          /= toJson (Effect.GrantPlayFromExile (GrantPlayFromExile.MkGrantPlayFromExile Duration.Indefinite (PlayerRef.Relative PlayerRelation.You) (ObjectRef.InSlot (SlotName.MkSlotName (Text.pack "plotted"))) ManaSpending.AsProduced False PermissionVerb.Play))
      )
