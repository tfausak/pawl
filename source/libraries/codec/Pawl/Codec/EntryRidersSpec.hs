...
spec s = Spec.describe s "Pawl.Codec.EntryRiders" $ do
  ...
  Spec.it s "MkEntryRiders, faceDown alone" $
    Common.assertCodec
      s
      EntryRiders.codec
      EntryRiders.MkEntryRiders {EntryRiders.tapped = TapState.Untapped, EntryRiders.attacking = Nothing, EntryRiders.blocking = Nothing, EntryRiders.transformed = False, EntryRiders.counters = Map.empty, EntryRiders.underOwner = False, EntryRiders.exiledFaceDown = False, EntryRiders.attachedTo = Nothing, EntryRiders.faceDown = Just FaceDownState.MkFaceDownState {FaceDownState.reason = FaceDownReason.Manifested, FaceDownState.listed = FaceDownCharacteristics.defaultValue}}
  ...
  Spec.it s "MkEntryRiders, faceDown with a listing of its own" $
    Common.assertCodec
      s
      EntryRiders.codec
      EntryRiders.MkEntryRiders {EntryRiders.tapped = TapState.Untapped, EntryRiders.attacking = Nothing, EntryRiders.blocking = Nothing, EntryRiders.transformed = False, EntryRiders.counters = Map.empty, EntryRiders.underOwner = False, EntryRiders.exiledFaceDown = False, EntryRiders.attachedTo = Nothing, EntryRiders.faceDown = Just FaceDownState.MkFaceDownState {FaceDownState.reason = FaceDownReason.EnteredFaceDown, FaceDownState.listed = FaceDownCharacteristics.defaultValue {FaceDownCharacteristics.typeLine = TypeLine.MkTypeLine {TypeLine.supertypes = Set.empty, TypeLine.types = Set.singleton CardType.Land, TypeLine.subtypes = Set.singleton Subtype.Forest}, FaceDownCharacteristics.power = Nothing, FaceDownCharacteristics.toughness = Nothing}}}
