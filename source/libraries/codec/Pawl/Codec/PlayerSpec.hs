...
spec s = Spec.describe s "Pawl.Codec.Player" $ do
  ...
  Spec.it s "a player at the start of an ordinary game" $
    Common.assertCodec
      ...
      " {\"life\":20,\"status\":{\"type\":\"Playing\"},\"counters\":[],\"ringTemptations\":0,\"speed\":null,\"commander\":null,\"commanderCasts\":0,\"commanderDamage\":{},\"dungeon\":null} "
