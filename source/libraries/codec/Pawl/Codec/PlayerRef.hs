...
-- | The wire format is unchanged by the conversion: these are the same four
-- tags the hand-written pair wrote, and 'Arm.tagged' emits them identically.
-- What it adds is the schema.
