...
codec =
  Fields.object $
    SpeedDecrease.MkSpeedDecrease
      <$> Fields.required "player" PlayerRef.codec SpeedDecrease.player
      <*> Fields.required "quantity" Quantity.codec SpeedDecrease.quantity
      <*> Fields.defaulted "floor" 0 Common.natural SpeedDecrease.floor
