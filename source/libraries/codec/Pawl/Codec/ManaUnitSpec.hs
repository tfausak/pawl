...
spec s = Spec.describe s "Pawl.Codec.ManaUnit" $ do
  ...
  Spec.it s "plain mana" $
    Common.assertCodec
      ...
      " {\"manaType\":{\"type\":\"Colorless\"},\"tags\":[],\"retention\":{\"type\":\"Ordinary\"},\"restriction\":null,\"rider\":null} "
  -- All five axes at once, each away from its default: CR 107.4h's snow tag, CR
  ...
  Spec.it s "snow mana kept until end of turn, spendable only on creature spells" $
    Common.assertCodec
      ...
      " {\"manaType\":{\"type\":\"Colored\",\"value\":{\"type\":\"Red\"}},\"tags\":[{\"type\":\"Snow\"}],\"retention\":{\"type\":\"UntilEndOfTurn\"},\"restriction\":{\"casts\":{\"type\":\"HasCardType\",\"value\":{\"type\":\"Creature\"}}},\"rider\":null} "
