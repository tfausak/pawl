...
spec s = Spec.describe s "Pawl.Codec.CardType" $ do
  ...
  Spec.it s "Battle" $ do
    Common.assertJsonCodec s CardType.toJson CardType.fromJson CardType.Battle "{\"type\":\"Battle\"}"

  Spec.it s "Conspiracy" $ do
    Common.assertJsonCodec s CardType.toJson CardType.fromJson CardType.Conspiracy "{\"type\":\"Conspiracy\"}"
  ...
  Spec.it s "Dungeon" $ do
    Common.assertJsonCodec s CardType.toJson CardType.fromJson CardType.Dungeon "{\"type\":\"Dungeon\"}"
  ...
  Spec.it s "Phenomenon" $ do
    Common.assertJsonCodec s CardType.toJson CardType.fromJson CardType.Phenomenon "{\"type\":\"Phenomenon\"}"

  Spec.it s "Plane" $ do
    Common.assertJsonCodec s CardType.toJson CardType.fromJson CardType.Plane "{\"type\":\"Plane\"}"
  ...
  Spec.it s "Scheme" $ do
    Common.assertJsonCodec s CardType.toJson CardType.fromJson CardType.Scheme "{\"type\":\"Scheme\"}"
  ...
  Spec.it s "Vanguard" $ do
    Common.assertJsonCodec s CardType.toJson CardType.fromJson CardType.Vanguard "{\"type\":\"Vanguard\"}"
