      ...
      exile =
        Effect.MoveToZone
          ( MoveToZone.MkMoveToZone
              ...
              Zone.Exile
              EntryRiders.MkEntryRiders {EntryRiders.tapped = TapState.Untapped, EntryRiders.attacking = Nothing, EntryRiders.blocking = Nothing, EntryRiders.transformed = False, EntryRiders.counters = Map.empty, EntryRiders.underOwner = False, EntryRiders.exiledFaceDown = False, EntryRiders.faceDown = Nothing}
              (Just Binding.became)
              Nothing
        ...
        Effect.OfferCast
          OfferCast.MkOfferCast
            { OfferCast.ref = ObjectRef.InSlot Binding.became,
              ...
              OfferCast.offer = CastOffer.MkCastOffer {CastOffer.transformed = True, CastOffer.withoutPayingManaCost = True, CastOffer.payingInstead = Nothing, CastOffer.spending = ManaSpending.AsProduced, CastOffer.restriction = Nothing}
            }
