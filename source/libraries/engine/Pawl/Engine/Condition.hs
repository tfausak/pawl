...
-- that may evaluate a Pawl.Types.Condition -- the standing Pawl.Engine.Expiry has over
-- Pawl.Types.Expiry and Pawl.Engine.Projection over Modification.
--
...
-- and Pawl.Engine.Stack's CR 608.2a re-check) pass Projection.viewWithLastKnown and not
