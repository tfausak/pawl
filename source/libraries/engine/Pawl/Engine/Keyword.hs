...
-- returns in the object's CR 612 text changes and is what Pawl.Engine.Event's EVENT scan
-- reads; printedTriggeredAbilitiesOf below is the in-module one. Rule 702 has no
