...
-- Rules 702.25, 702.45, 702.70, 702.86, 702.91, 702.108, 702.121 and 702.130 do
-- not: they spell flanking, bushido, poisonous, annihilator, battle cry,
-- prowess, melee and afflict out as TRIGGERED abilities, so those have to be
...
-- melee and CR 702.130b of afflict, so the eight minting arms below are the same
...
-- for each opponent you attacked with a creature this combat. The EIGHTH keyword
-- rule 702 states as a triggered ability, minted here like the seven around it.
--
