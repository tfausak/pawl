                ...
                let g1 = Game.removeFromZones pid oid g
                 in g1
                      { GameState.objects = Map.delete oid (GameState.objects g1),
                        ...
                        GameState.lastKnown = Map.insert oid (LastKnown.MkLastKnown snapshot lastController (Object.owner obj) (Object.source obj) (Object.counters obj) (copiedSnapshot oid gs) (Object.attachedTo obj) (Object.chosenNames obj) (Game.isBlocking oid gs)) (GameState.lastKnown g1)
                      }
    ...
    let snapshot = Projection.project oid gs
     ...
     in cleared
          { GameState.objects = Map.delete oid (GameState.objects cleared),
            GameState.lastKnown = Map.insert oid (LastKnown.MkLastKnown snapshot lastController (Object.owner obj) (Object.source obj) (Object.counters obj) (copiedSnapshot oid gs) (Object.attachedTo obj) (Object.chosenNames obj) (Game.isBlocking oid gs)) (GameState.lastKnown cleared)
          }
