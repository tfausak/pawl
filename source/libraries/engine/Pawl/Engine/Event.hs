                ...
                let g1 = Game.removeFromZones pid oid g
                 in g1
                      { GameState.objects = Map.delete oid (GameState.objects g1),
                        ...
                        GameState.lastKnown = Map.insert oid (LastKnown.MkLastKnown snapshot lastController (Object.owner obj) (Object.source obj) (Object.counters obj) (copiedSnapshot oid gs) (Game.attachments oid lki) (Object.chosenNames obj) (Game.attackTargetOf oid gs) (Game.isBlocking oid gs) (Object.protector obj)) (GameState.lastKnown g1)
                      }
    ...
    let snapshot = Projection.project oid gs
     ...
     in cleared
          { GameState.objects = Map.delete oid (GameState.objects cleared),
            GameState.lastKnown = Map.insert oid (LastKnown.MkLastKnown snapshot lastController (Object.owner obj) (Object.source obj) (Object.counters obj) (copiedSnapshot oid gs) (Game.attachments oid gs) (Object.chosenNames obj) (Game.attackTargetOf oid gs) (Game.isBlocking oid gs) (Object.protector obj)) (GameState.lastKnown cleared)
          }
