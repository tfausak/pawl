    ...
    let snapshot = Projection.project oid gs
     ...
     in cleared
          { GameState.objects = Map.delete oid (GameState.objects cleared),
            GameState.lastKnown = Map.insert oid (LastKnown.MkLastKnown snapshot lastController (Object.owner obj) (Object.source obj) (Object.counters obj) (copiedSnapshot oid gs) (Game.attachments oid gs) (Object.chosenNames obj) (Game.isAttacking oid gs) (Game.attackTargetOf oid gs) (Game.isBlocking oid gs) (Object.protector obj) (Object.paidCosts obj) (Object.controlClock obj)) (GameState.lastKnown cleared)
          }
