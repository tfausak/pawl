...
data Face card = MkFace
  { name :: CardName.CardName,
    ...
    --
    -- The STATIC prohibition only. The one-shot -- "doesn't untap during its
    -- controller's NEXT untap step", and CR 701.43a's exert -- is
    -- Object.doesNotUntapNext on the victim, and never reaches this field.
