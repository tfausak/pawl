...
data Quantity
  ...
  | -- | CR 122.1: how many counters of EVERY kind are on the OBJECT this quantity
    ...
    -- nothing else (data/cards/angelic-sleuth.json).
    --
  ...
  | -- | CR 119.3 / 608.2i: how much life that player has GAINED this turn --
    ...
    -- Celestine, the Living Saint and Ratchet, Field Medic print the same amount
    -- as a BOUND on a target's mana value, which is Pawl.Types.TargetSlot's
    -- `amount` carrying this quantity and Filter.ManaValueAtMostAmount reading it.
    --
