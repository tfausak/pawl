...
-- which Pawl.Engine.Event.perpetuate re-anchors to every incarnation that
-- arrives -- CR 712.21c's two, where a melded permanent left the battlefield).
-- A static ability's set is DYNAMIC: Matching,
