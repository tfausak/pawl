...
data CopyException
  ...
  | -- | CR 707.9b over CR 105.2: the copy is exactly these colours ("except it's white").
    SetColors (Set.Set Color.Color)
  | -- | CR 707.9b over CR 202.1: the copy has no mana cost, so CR 202.3a's mana value 0.
    NoManaCost
