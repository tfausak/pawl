...
data ManaSymbol
  ...
  | -- | CR 107.4f: payable either with one mana of its colour or by paying 2 life
    ...
    -- spell (CR 118.13a) or immediately before a resolution-time cost (CR
    -- 118.13b), a special action's cost (CR 118.13c) or a combat toll is paid,
    -- so this symbol is gone before the cost is paid.
    --
  ...
  | -- | CR 107.4h: {S} in a cost, payable with one mana of any type produced by a
    ...
    -- about it through Pawl.Types.Quantity.TagWasSpent (rule 702.191a's increment
    -- asks the same record how MANY). Nothing in a COST
