...
data GameEvent
  ...
  | -- | CR 701.43a: this permanent was EXERTED. Recorded by
    ...
    -- trigger against the event as it happens. The PROHIBITION outlives that moment and a control change
    -- can separate the two, so it records the player itself in
    -- Object.exertedBy rather than re-deriving one from this id.
    --
