...
data GameEvent
  ...
  | -- | A permanent left the GAME, rather than the battlefield. Two roads reach
    ...
    -- CR 729.4a's it is CR 702.26b, which no rule of 729 excepts a phased-out
    -- permanent from -- see Pawl.Engine.Setup.applyCrossings.
    --
  ...
  | -- | CR 706.1: a player rolled a die. Recorded by
    ...
    -- AFTER CR 706.2's result is settled and bound.
    --
