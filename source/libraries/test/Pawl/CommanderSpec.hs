...
commanderBoard mountain shimatsu lands =
  let deck = Deck.MkDeck {Deck.cards = Map.empty, Deck.commander = Set.singleton shimatsu, Deck.vanguard = Nothing, Deck.dungeons = Set.empty, Deck.sideboard = Map.empty, Deck.conspiracies = Map.empty, Deck.attractions = Map.empty}
...
designationSpec s registry = Spec.describe s "Designation" $ do
  ...
  Spec.it s "CR 113.6b/113.6c a commander's ability that states the command zone functions from there" $ do
    ...
    walls <- S.printingOf s registry "The Walls of Ba Sing Se"
    piker <- S.printingOf s registry "Goblin Piker"
    let deckFor c = Deck.MkDeck {Deck.cards = Map.empty, Deck.commander = Set.singleton c, Deck.vanguard = Nothing, Deck.dungeons = Set.empty, Deck.sideboard = Map.empty, Deck.conspiracies = Map.empty, Deck.attractions = Map.empty}
...
partnerBoard mountain plains lands commanders =
  let deck = Deck.MkDeck {Deck.cards = Map.empty, Deck.commander = Set.fromList commanders, Deck.vanguard = Nothing, Deck.dungeons = Set.empty, Deck.sideboard = Map.empty, Deck.conspiracies = Map.empty, Deck.attractions = Map.empty}
      board =
...
designating seats gs0 =
  let one g (pid, printing) =
        S.runPure S.identityAnswer g $
          Setup.createDeck pid Deck.MkDeck {Deck.cards = Map.empty, Deck.commander = Set.singleton printing, Deck.vanguard = Nothing, Deck.dungeons = Set.empty, Deck.sideboard = Map.empty, Deck.conspiracies = Map.empty, Deck.attractions = Map.empty}
...
brawlDesignating commander =
  let empty = Setup.emptyGame S.bothPlayers
      brawling = empty {GameState.settings = (GameState.settings empty) {GameSettings.brawl = True}}
      deck = Deck.MkDeck {Deck.cards = Map.empty, Deck.commander = Set.singleton commander, Deck.vanguard = Nothing, Deck.dungeons = Set.empty, Deck.sideboard = Map.empty, Deck.conspiracies = Map.empty, Deck.attractions = Map.empty}
...
subgameParent mountain shimatsu =
  let deck = Deck.MkDeck {Deck.cards = Map.singleton mountain 5, Deck.commander = Set.singleton shimatsu, Deck.vanguard = Nothing, Deck.dungeons = Set.empty, Deck.sideboard = Map.empty, Deck.conspiracies = Map.empty, Deck.attractions = Map.empty}
