...
-- of a graveyard that is not the caster's own (CR 400.3, Cast.zoneCandidates;
-- Pawl.Engine.Quantity's WasCastFrom arm carries the proof and the one road that
-- could break it, #2689). EachPlayer would be the wrong call there: it reads
