...
-- effect that specifically removes it (Pawl.Resolve), and the two derived clauses
-- a controller change and a creature that stops being one (Pawl.Combat.removeChanged).
