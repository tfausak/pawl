module Pawl.Type.Counterability where
...
-- Cancel does not -- the opposite arrangement from Pawl.Type.Regenerability,
...
-- which is exactly CR 113.6g's stack. But Pawl.Type.StaticAbility implements only
