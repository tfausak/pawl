...
- [ ] **Step 3: Add the field to `Object`**
...
- [ ] **Step 4: Reset damage in `changeZone`, and set it at creation**
...
- [ ] **Step 6: Remove damage at cleanup**
...
- [ ] **Step 7: Fix every other `Object.MkObject` site**
...
- [ ] **Step 3: Add the object facts to `Pawl.Game`**
...
- [ ] **Step 3: Create the combat types**
...
- [ ] **Step 4: Add the field to `GameState` and `Setup`**
...
- [ ] **Step 5: Update every interpreter**
...
- [ ] **Step 3: Add the declaration sequences**
...
- [ ] **Step 4: Wire the declaration steps into the engine**
...
- [ ] **Step 3: Add the CR 510 sequence**
...
- [ ] **Step 4: Wire the damage and end-of-combat steps into the engine**
...
- [ ] **Step 1: Make the random interpreter fight**
...
- [ ] **Step 2: Replace the property list**
...
- [ ] **Step 4: Add the combat benchmark**
