...
- [ ] **Step 3: Add `manaPool` to `GameState`**
...
- [ ] **Step 4: Add the field to `Setup.emptyGame` and the test fixture**
...
- [ ] **Step 3: Replace `createMountain` with `createCard` and add `deckList`**
