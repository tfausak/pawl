...
- [x] **Step 4: Offer casts in `legalActions`**
...
- [x] **Step 5: Restructure `priorityLoop` and `runStep`**
...
- [x] **Step 1: Make the random interpreter exercise casting**
...
- [x] **Step 3: Add the casting benchmark**
